...
'use strict';
var AnimationLoop, Config, Game, HeadsUp, Input, Particle, ParticleGenerator, Scenes, State, Utils, android, animationLoop, animationLoopId, backingStoreRatio, canvas, config, context, debug, devicePixelRatio, game, hasTouchEvents, headsUp, homeScreenApp, iOS, input, inputVerb, oldHeight, oldWidth, particleGenerator, ratio, scenes, state, utils;
